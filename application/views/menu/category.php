...
<head>
  <meta charset="utf-8">
  <title><?= htmlspecialchars($current_category['name'], ENT_QUOTES, 'UTF-8') ?> - Warkop Abah</title>
    ...
    <div class="container mt-4">
      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page"><?= htmlspecialchars($current_category['name'], ENT_QUOTES, 'UTF-8') ?></li>
        </ol>
      </nav>
        ...
        <div class="col-12">
          <div class="card border-0 shadow-sm">
            <div class="card-body text-center" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white;">
              <h2 class="mb-2"><i class="fas fa-tag mr-2"></i><?= htmlspecialchars($current_category['name'], ENT_QUOTES, 'UTF-8') ?></h2>
              <p class="mb-0">Nikmati berbagai pilihan menu dalam kategori ini</p>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="card-body">
              <form action="<?= site_url('menu/search'); ?>" method="GET">
                <div class="input-group">
                  <input type="text" class="form-control" name="q" placeholder="Cari menu...">
            ...
            <div class="card-body">
              <div class="row">
                ...
                <?php foreach ($categories as $category): ?>
                  <div class="col-md-3 mb-2">
                    <a href="<?= site_url('menu/category/' . $category['id']); ?>" class="btn btn-outline-primary btn-block <?= $current_category['id'] == $category['id'] ? 'active' : '' ?>">
      ...
      <div class="row">
        <div class="col-12">
          <div class="card border-0 shadow-sm">
            <div class="card-header bg-white">
              <h5 class="mb-0">
                <i class="fas fa-list mr-2"></i>Menu <?= htmlspecialchars($current_category['name'], ENT_QUOTES, 'UTF-8') ?>
                <span class="badge badge-primary ml-2"><?= count($menus) ?> item</span>
              </h5>
            </div>
            <div class="card-body">
              <div class="row">
                ...
                <?php else: ?>
                  <div class="col-12">
                    <div class="text-center text-muted py-5">
                      ...
                      <p>Belum ada menu dalam kategori "<?= htmlspecialchars($current_category['name'], ENT_QUOTES, 'UTF-8') ?>" saat ini.</p>
                      <a href="<?= site_url('menu'); ?>" class="btn btn-primary">
                        <i class="fas fa-arrow-left mr-2"></i>Kembali ke Semua Menu
                      </a>
                    </div>
                  </div>
                <?php endif; ?>
